...
<h2> Welcome <b><?php echo htmlspecialchars($_SESSION["ADMIN_USERNAME"]); ?></b></h2>
	 ...
	 <button id="print" onClick="printContent('hostel')"><b>PRINT</b></button>
...
$conn = new mysqli($servername, $username, $password, $dbname);
							...
							$sql = "SELECT id,hostel_name,number_of_room,location,room_price,room_type,status,created_date FROM hostel";
						$i=1;
							...
							<tr>
							 ...
							 <th><?php echo $row['id']?></th>
							   <th><?php echo $row['hostel_name']?></th>
							    <th><?php echo $row['number_of_room']?></th>
