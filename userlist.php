...
<h2> Welcome <b><?php echo htmlspecialchars($_SESSION["ADMIN_USERNAME"]); ?></b></h2>
	 ...
	 <button id="print" onClick="printContent('userlist')"><b>PRINT</b></button>
...
$conn = new mysqli($servername, $username, $password, $dbname);
							...
							$sql = "SELECT user_id,first_name,last_name,email,telephone,username,gender,studies_details,country FROM signin";
						$i=1;
							...
							<tr>
							 ...
							 <th><?php echo $row['gender']?></th>
							   <th><?php echo $row['studies_details']?></th>
